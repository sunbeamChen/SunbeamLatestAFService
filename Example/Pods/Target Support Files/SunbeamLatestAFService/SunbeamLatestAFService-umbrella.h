...
#import "SunbeamLatestAFService.h"
#import "SLAFTool.h"

FOUNDATION_EXPORT double SunbeamLatestAFServiceVersionNumber;
FOUNDATION_EXPORT const unsigned char SunbeamLatestAFServiceVersionString[];
